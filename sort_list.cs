    ...
    internal class Program
{
    static void Main(string[] args)
    {
         ...
         */
        string file_1 = Path.Combine(Directory.GetCurrentDirectory(), "file_1.txt");//@"file_1.txt"; //Path.Combine(Directory.GetCurrentDirectory(), "file_1.txt");
        string file_2 = Path.Combine(Directory.GetCurrentDirectory(), "file_2.txt");//@"file_2.txt"; //Path.Combine(Directory.GetCurrentDirectory(), "file_2.txt");
        string output_file = Path.Combine(Directory.GetCurrentDirectory(), "file_sol.txt");//@"file_sol.txt"; //Path.Combine(Directory.GetCurrentDirectory(), "file_sol.txt");
